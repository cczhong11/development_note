...
1. AI 技术栈概览
	...
	•	基础设施层：包括 Serving Infra、数据管理（Data Ops）与模型运行监控（Monitoring）。
...
2. 应用开发层（Application Development）
	...
	•	模块化思路：Planner → Executor → Verifier
	3.	Prompt Engineering
	•	技术手段：零样本、少样本、链式思维（Chain-of-Thought）
	•	动态上下文筛选与检索增强（Retrieval-Augmented Generation）
...
3.1 数据来源与处理
	...
	•	数据清洗与预处理：去重、过滤低质量、子词切分（BPE/WordPiece）
