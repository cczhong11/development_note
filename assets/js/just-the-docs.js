(function (jtd, undefined) {
    ...
    function initNavBar() {
      return fetch("https://notes.tczhong.com/nav.html").then(function (response) {
    ...
    function initSearch() {
      ...
      request.open("GET", "https://notes.tczhong.com/assets/js/search-data.json", true);
    ...
    jtd.setTheme = function (theme) {
      ...
      cssFile.setAttribute(
        "href",
        'https://notes.tczhong.com/assets/css/just-the-docs-' + theme + ".css"
      );
    };
